---
title: "A-B Testing"
description: "Running controlled experiments to determine whether a change genuinely causes an improvement, rather than relying on correlation alone."
---
...
A/B testing directly applies [HYPOTHESIS TESTING](/docs/statistics/hypothesis-testing) concepts to a business context, and is often the strongest available tool for establishing that a change actually causes an improvement, addressing the limitations discussed in [CORRELATION VS CAUSATION](/docs/statistics/correlation-vs-causation).
