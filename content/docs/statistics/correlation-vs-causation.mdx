...
description: "Why two variables moving together doesn't mean one causes the other — one of the most important distinctions in analytics."
---
...
Correlation alone cannot distinguish between these — determining the real explanation typically requires controlled experimentation (see [A-B TESTING](/docs/statistics/a-b-testing)) or careful analysis controlling for confounding variables.
