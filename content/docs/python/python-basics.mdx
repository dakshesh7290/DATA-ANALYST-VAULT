---
title: "Python Basics"
description: "The foundational Python every Data Analyst needs: variables, data types, control flow, and functions — focused on analyst use, not general software en"
---
...
- Using loops for operations Pandas/NumPy can do far more efficiently in vectorized form (see [NUMPY](/docs/python/numpy), [PANDAS](/docs/python/pandas))
...
Python Basics is the foundation for everything else in this section — [NUMPY](/docs/python/numpy), [PANDAS](/docs/python/pandas), and [AUTOMATION](/docs/python/automation) all assume comfort with these fundamentals.
