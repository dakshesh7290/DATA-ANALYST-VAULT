...
description: "Calculating values across a set of related rows without collapsing them into a single summary row — rankings, running totals, and row-to-row compariso"
---
