...
description: "How data moves from source systems into analysis-ready form, and what a Data Analyst needs to understand about this process."
---
...
ETL is what makes the "gather data" stage of the [WORKFLOW](/docs/map-of-content/workflow) possible in a structured, repeatable way, and understanding it helps explain data quality issues encountered later in that workflow.
